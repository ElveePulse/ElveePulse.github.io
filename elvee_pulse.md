...
Push Button
  ...
  <script src="/assets/application-e3d278fbffad9f8318498567fc6363131ddf569c8567f27de00db057e505e866.js"></script>
    ...
    $(document).on('page:load ready', function() {
      ...
      $.getJSON('https://thingspeak.com/channels/1520544/field/4.json?&amp;offset=0&amp;results=60', function(data) {
            ...
            chart: {
              ...
              events: {
                load: function() {
                  ...
                  var url = 'https://thingspeak.com/channels/1520544/feed/last.json?&amp;offset=0&amp;location=true&amp;results=60';
                  if ("".length > 0) {
                    url = 'https://thingspeak.com/channels/1520544/feed/last_average.json?&amp;offset=0&amp;location=true&amp;average=&amp;results=60';
                  } else if ("".length > 0) {
                    url = 'https://thingspeak.com/channels/1520544/feed/last_median.json?&amp;offset=0&amp;location=true&amp;median=&amp;results=60';
                  } else if ("".length > 0) {
                    url = 'https://thingspeak.com/channels/1520544/feed/last_sum.json?&amp;offset=0&amp;location=true&amp;sum=&amp;results=60';
                  }
