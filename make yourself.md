...
<button name="button" style="background: #069cc2; border-radius: 6px; padding: 15px; cursor: pointer; color: #fff; border: none; font-size: 16px; margin-right: 900px; float: right;" >CH340 Driver </button>
</form>
...
<button name="button" style="background: #069cc2; border-radius: 6px; padding: 15px; cursor: pointer; color: #fff; border: none; font-size: 16px; margin-right: 900px; float: right;" > Arduino IDE </button>
</form>
...
<button name="button" style="background: #069cc2; border-radius: 6px; padding: 10px; cursor: pointer; color: #fff; border: none; font-size: 16px; margin-right: 900px; float: right;" > Setting up ESP8266 on Arduino IDE </button>
</form>